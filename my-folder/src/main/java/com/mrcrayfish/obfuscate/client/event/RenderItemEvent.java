...
public class RenderItemEvent extends Event
{
    ...
    /**
     * Gets the display context of the render
     */
    ...
    public static class Held extends RenderItemEvent
    {
        ...
        {
            public Pre(LivingEntity entity, ItemStack heldItem, ItemDisplayContext displayContext, PoseStack poseStack, MultiBufferSource source, HumanoidArm arm, int light, int overlay, float deltaTicks)
            {
                super(entity, heldItem, displayContext, poseStack, source, arm, light, overlay, deltaTicks);
            }
        }
        ...
        {
            public Post(LivingEntity entity, ItemStack heldItem, ItemDisplayContext displayContext, PoseStack poseStack, MultiBufferSource source, HumanoidArm arm, int light, int overlay, float deltaTicks)
            {
                super(entity, heldItem, displayContext, poseStack, source, arm, light, overlay, deltaTicks);
            }
    ...
    public static class Gui extends RenderItemEvent
    {
        ...
        {
            super(heldItem, ItemDisplayContext.GUI, poseStack, source, light, overlay, Minecraft.getInstance().getFrameTime());
        }
    ...
    public static class ItemFrame extends RenderItemEvent
    {
        ...
        public ItemFrame(ItemFrame entity, ItemStack heldItem, PoseStack poseStack, MultiBufferSource source, int light, int overlay, float deltaTicks)
        {
        ...
        {
            public Pre(ItemFrame entity, ItemStack heldItem, PoseStack poseStack, MultiBufferSource source, int light, int overlay, float deltaTicks)
            {
                super(entity, heldItem, poseStack, source, light, overlay, deltaTicks);
            }
        }
        ...
        {
            public Post(ItemFrame entity, ItemStack heldItem, PoseStack poseStack, MultiBufferSource source, int light, int overlay, float deltaTicks)
            {
                super(entity, heldItem, poseStack, source, light, overlay, deltaTicks);
            }
    ...
    public static class Head extends RenderItemEvent
    {
        ...
        {
            super(heldItem, ItemDisplayContext.HEAD, poseStack, source, light, overlay, deltaTicks);
            this.entity = entity;
        }
